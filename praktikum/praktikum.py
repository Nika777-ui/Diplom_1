...
def main():
    ...
    Демонстрирует работу бургерной: создает бургер, добавляет ингредиенты,
    перемещает и удаляет их, затем печатает чек.
    """
...
# Блок для выполнения при прямом запуске скрипта
